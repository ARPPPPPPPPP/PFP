			...
			<div class="content-box">
				...
				<div class="content-box-content">
							...
							<tbody>
								<?php if(is_array($list)): foreach($list as $key=>$item): ?><tr>
									<td><input type="checkbox" name='checkboxscut'
										id='<?php echo ($item[systemsettingid]); ?>' /></td>
									<td><?php echo ($item[systemsettingname]); ?></td>
									<td
										style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"
										title="<?php echo ($item[systemsettingcontent]); ?>"><?php echo ($item[systemsettingcontent]); ?></td>
									<td><a
										href="<?php echo U('SystemSetting/editSystemSetting','systemsettingid=' . $item[systemsettingid]);?>"
										title="Edit" target="_blank"><img
											src="/PFP/Public/resources/images/icons/pencil.png" alt="Edit" /></a>
										<a
										href="<?php echo U('SystemSetting/systemSetting','delete=' . $item[systemsettingid]);?>"
										title="Delete"><img
					...
					<div class="tab-content" id="tab2">
						<form action="<?php echo U('SystemSetting/addSystemSetting');?>"
							method="post">
							<fieldset>
...
<script type="text/javascript">
	function deleteMulti() {
		if (confirm('Do Delete?')) {
			...
			window.location = "<?php echo U('SystemSetting/systemSetting','deleteMulti=-1');?>"
					+ "," + value.toString();
		}
	}
</script>