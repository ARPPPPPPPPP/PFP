			...
			<div class="content-box">
				...
				<div class="content-box-content">
						...
						<table>
							...
							<tbody>
								<?php if(is_array($list)): foreach($list as $key=>$item): ?><tr>
									...
									<td><a
										href="<?php echo U('Download/editDownload','downloadid=' . $item[downloadid]);?>"
										title="Edit" target="_blank"><img
											src="/PFP/Public/resources/images/icons/pencil.png" alt="Edi" /></a>
										<a
										href="<?php echo U('Download/allDownload','delete=' . $item[downloadid]);?>"
										title="Delete"><img
					...
					<div class="tab-content" id="tab2">
						<form action="<?php echo U('Download/addDownload');?>"
...
<script type="text/javascript">
	function deleteMulti() {
		if (confirm('Do Delete?')) {
			...
			window.location = "<?php echo U('Download/allDownload','deleteMulti=-1');?>"
					+ "," + value.toString();
		}
	}
</script>