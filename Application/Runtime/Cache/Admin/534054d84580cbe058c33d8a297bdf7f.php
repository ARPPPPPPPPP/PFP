	...
	<div id="main-content" style="width: 75%; margin: 0 auto;">
		<div class="content-box">
			...
			<div class="content-box-header">
				<h3>SystemSetting:<?php echo ($systemSetting['systemsettingname']); ?></h3>
			...
			<div class="content-box-content">
				<form
					action="<?php echo U('SystemSetting/editSystemSettingSubmit','systemsettingid=' . $systemSetting[systemsettingid]);?>"
					method="post">
					<fieldset>
						...
						<p>
							...
							<textarea class="text-input medium-input datepicker" type="text"
								id="medium-input" name="systemsettingcontent"
								style="height: 200px; overflow: auto;"><?php echo ($systemSetting['systemsettingcontent']); ?></textarea>
							<br />
						</p>
						<p>
